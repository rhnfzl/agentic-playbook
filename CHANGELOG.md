...
- **CI gates**: `make check` runs 15 gates (frontmatter, AGENTS.md governance, external-skill audit, size policy, decay, em-dashes, no-versions, skill-description length, hook metadata, hook-source unification, pyright zero, human-html allowlist, ADR uniqueness, ignored-containment, playbook-version).
