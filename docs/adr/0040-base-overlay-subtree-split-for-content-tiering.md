...
1. **STRICT team-only** (file IS a team-only artifact, tied to internal services/tooling):
...
cases:
  - name: code-review-happy-path
    required_scope: ["team"]
    skill: overlays/team/skills/engineering/code-review  # post-refactor path
    ...
```
