...
| `tech-lead.toml` | Tech leads | 10 engineering skills (ci-failure-triage, code-review-graph-first, diagnose, improve-codebase-architecture, post-iter-review, prototype, tdd, to-issues, to-prd, triage) + ask-colleague + ask-team + grill-me + handoff + 2 observability skills + 7 meta skills (agents-md-curator, audit-docs, playbook-promote, playbook-retrospective, skill-cleaner, write-a-skill, zoom-out), always-on rules, 4 hooks (lint-guard, never-push-to-develop, human-html-autoindex, agent-memory-session-brief), code-review-graph + slack + tavily MCPs |
