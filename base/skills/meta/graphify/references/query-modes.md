# Query Modes (query, path, explain)

Companion reference for `skills/meta/graphify/SKILL.md`. Cover the three query subcommands.
...
Replace `QUESTION` with the question, `ANSWER` with your full answer text, `SOURCE_NODES` with the list of node labels you cited. Closes the feedback loop: the next `--update` will extract this Q&A as a node in the graph.

## For /graphify path

Find the shortest path between two named concepts in the graph.

First check the graph exists (same probe as above). Then:
